...
class AppModule extends Module {
  ...
  List<Bind<Object>> get binds => [
        ...
        Bind.singleton((i) => TranslatedWordDatasourceImp()),
        Bind.singleton((i) => FoodClassificationRemoteDatasourceImp(i())),
        Bind.singleton((i) => FoodsDatasourceImp(i(), i())),
        Bind.singleton((i) => MealDatasourceImp(i(), i())),
        Bind.singleton((i) => MealItemDatasourceImp(i(), i())),
        Bind.singleton((i) => MealTypeDatasourceImp(i(), i())),
